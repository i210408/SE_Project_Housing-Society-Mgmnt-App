<%@ Page Title="About" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Reservation.aspx.cs" Inherits="UserInterfaceLayer.Reservation" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br />
    <asp:Label ID="Label13" runat="server" Text="Reservations"></asp:Label>

</th>
            <th id="Work" style="border:8px double #CC5500; border-radius:5px; width: 991px; height: 579px;">
                <label style="font-size:3vw;color:#F08269;font-family:Arial, Helvetica, sans-serif"><u>Reserve An Event Day</u></label>
                <br />
<br />
<br />
<asp:Label ID="Label1" runat="server" Text="Reservation Reason: "></asp:Label>
<asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
<br />
<asp:Label ID="Label6" runat="server" Text="Reservation Description: "></asp:Label>
<asp:TextBox ID="TextBox2" runat="server"></asp:TextBox>
<br />
<asp:Label ID="DaysTillEvent" runat="server" Text="Days Till Event: "></asp:Label>
<asp:TextBox ID="TextBox3" runat="server"></asp:TextBox>
<br />
<br />
<asp:Button ID="AddEvent" runat="server" OnClick="AddEvent_Click" Text="Add To Calendar" />
<br />
<br />
<br />
