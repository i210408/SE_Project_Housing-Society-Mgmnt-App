...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br />
    <asp:Label ID="Label9" runat="server" Text="View Feedback"></asp:Label>
    <br />
    <br />
    <asp:ImageButton ID="ImageButton2" runat="server" src="dispatchworkersicon.png" OnClick="ImageButton2_Click" />
    <br />
    <asp:Label ID="Label10" runat="server" Text="Dispatch Maintainenece Workers"></asp:Label>
    <br />
    <br />
    <asp:ImageButton ID="ImageButton3" src="createpollicon.png" runat="server" OnClick="ImageButton3_Click" />
    <br />
    <asp:Label ID="Label11" runat="server" Text="Create Poll"></asp:Label>
    <br />
</th>
